...
define('content/sections',[], function () {
    ...
    return [{
        ...
        type: 'content',
        template: '<p>' + filler1 + '</p><a href="staffing/apply" class="staffing-section__apply-button">Apply to work</a>'
    }, {
        label: 'fourth-section-gap',
        type: 'section-gap'
    }, {
        label: 'entertainment',
        title: 'Entertainment',
        ...
        type: 'content',
        template: '<p>' + filler2 + '</p><a href="entertainment/apply" class="entertainment-section__apply-button">Apply to perform</a>'
    }, {
        label: 'fifth-section-gap',
        type: 'section-gap'
    }, {
        label: 'committee',
        title: 'Committee',
...
define('views/section-gap',[
    ...
    return Backbone.View.extend({
        ...
        render: function () {
            ...
            $('<div>').addClass('section--section-gap__img ' + ' section--' + sectionLabel + '__img').appendTo(this.$el);
