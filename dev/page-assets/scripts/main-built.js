...
|-------------------------------------------
|
| a function to load skrollr for the page, after the initial rendering has been completed
|
| type:         function
...
define('lib/skrollr/init-skrollr',['require'],function (require) {
    return function (options) {
        var s,
            // hack to trick skrollr into giving me `skrollr` directly, without attaching to window or calling `define` invalidly
        ...
        // not exposed to `window` as amd is available
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define('jqueryBem',['jquery'], factory);
    } else {
        // Browser globals
        factory(this.$);
    }
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define('jqueryBreakpoint',['jquery'], factory);
    } else {
        // Browser globals
        factory(this.$);
    }
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define('jqueryMayBall',['jquery'], factory);
    } else {
        // Browser globals
        factory(this.$);
    }
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define('underscore-mixins',['underscore'], factory);
    } else {
        // Browser globals
        factory(this._);
    }
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define('backboneBem',['backbone'], factory);
    } else {
        // Browser globals
...
|-------------------------------------------
|
| the instance of Router which controls the page navigations
|
| type:     Router
| author:   Josh Bambrick
| version:  0.0.1
...
define('routers/router.instance',[
    'routers/router'
], function (
    Router
) {
...
|-------------------------------------------
|
| a Backbone collection which is contains articles
|
| type:         class
...
define('text!templates/entertainment.html',[],function () { return '<!--\r\n--><div class="section--entertainment__act-hero"><!--\r\n\t\t<div class="section--entertainment__act-logo section--entertainment__act-logo--james-bay section--entertainment__act-logo--hero"></div><!--\r\n\t\t--><div class="section--entertainment__act-hero-description">We are delighted to announce our headliner for the 2015 ball is <strong>James Bay</strong>. James won the Critics Choice award at this year\'s BRIT awards and his debut album \'Chaos and the Calm\' shot to number 1 in the UK charts.</div><!--\r\n--></div><!--\r\n<div class="section--entertainment__act-list"><!--\r\n</div><!--\r\n--><p>Check back for more acts to be announced soon.</p>';});
...
define('collections/sections.instance',[
...
define('lib/skrollr/init-skrollr-stylesheets',[],function () {
    return function () {
